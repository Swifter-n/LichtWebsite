...
if(isset($_POST['submit'])){
    ...
    mysqli_query($db, "INSERT INTO post VALUES('','$category_id','$title','$description','$file_name','$date')");
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="row">
 <div class="col-lg-6">
        <form class="navbar-form navbar-left" role="search" method="post" action="index.php?post-search">
        <div class="form-group">
        <input type="text" name="keyword" class="form-control" placeholder="Search Post...">
        </div>
        <button type="submit" name="btn_search" class="btn btn-default">Search Post</button>
      </form>
    </div>
    </div>
        <div class="panel panel-default">
