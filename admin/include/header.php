            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="index.php?slider">Highline</a></li>
                        <li><a href="index.php?line">Line Product</a></li>
                        <li><a href="index.php?website">Product Website</a></li>
                        <li><a href="index.php?apps">Product Application</a></li>
                        <li><a href="index.php?games">Product Games</a></li>
                        <li><a href="index.php?project">Project Request</a></li>
                         <li><a href="index.php?member">Members</a></li>
